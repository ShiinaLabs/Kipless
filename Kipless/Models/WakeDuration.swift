...
enum WakeDuration: String, CaseIterable, Identifiable, Sendable {
    ...
    var title: String {
        switch self {
        case .minutes15: String(localized: LocalizedStringResource.durationMinutes15)
        case .minutes30: String(localized: LocalizedStringResource.durationMinutes30)
        case .hour1: String(localized: LocalizedStringResource.durationHour1)
        case .hour2: String(localized: LocalizedStringResource.durationHour2)
        case .indefinite: String(localized: LocalizedStringResource.durationIndefinite)
        }
    }
}
